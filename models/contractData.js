...
const ContractData = sequelize.define(
  "contractData", // Model name
  {
    ...
    contract6: { // Added 'Contract 6' field
      type: DataTypes.STRING(100),
      field: 'Contract 6',
    },
    optionMsisdn6: { // Added 'Option MSISDN 6' field
      type: DataTypes.STRING(20),
      field: 'Option MSISDN 6',
    },
    contractOption1Sub: {
      type: DataTypes.STRING(100),
    ...
    contractOption6Sub: { // Added 'Contract option 6 sub' field
      type: DataTypes.STRING(100),
      field: 'Contract option 6 sub',
    },
