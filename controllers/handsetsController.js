...
exports.postHandset = async (req, res) => {
  ...
  console.log("Request body: ",req.body)
   ...
   if (!EmployeeCode || !AllocationID || !HandsetName || HandsetPrice === undefined || AccessFeePaid === undefined) {
    return res.status(400).json({ message: "Please provide all required fields: EmployeeCode, AllocationID, HandsetName, HandsetPrice, AccessFeePaid." });
  }
  try{
